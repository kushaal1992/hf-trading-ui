    ...
    <div className="">
      <div className="h-[100vh] grid grid-rows-10 gap-4">
        <div className="row-span-5">
          <div className="h-full grid grid-cols-10 gap-3 text-center border border-inherit">
            <div className="col-span-1 overflow-y-auto">
              <div className="flex flex-col gap-2">
                <div className="flex flex-col gap-2">
                  <label className="text-base">Strike Range</label>
                  <div>
                    <label
                      htmlFor="from_range"
            ...
            <div className="col-span-2 overflow-y-auto">
              <label className="text-base">CALLS</label>
              <table className="h-full max-w-fit  divide-y divide-gray-200">
                <thead>
                  <tr>
                    <th
            ...
            <div className="col-span-2 overflow-y-auto">
              <label className="text-base">PUTS</label>
              <table className="h-full max-w-fit divide-y divide-gray-200">
                <thead>
                  <tr>
                    <th
        ...
        <div className="row-span-5">
          <div className="h-full grid grid-cols-10 gap-3 text-center border border-inherit">
            ...
            <div className="col-span-1 overflow-y-auto">
              <div className="flex flex-col justify-center items-center gap-12">
                <label className="text-base absolute z-10">Actions</label>
                <div className="flex flex-row gap-1">
                  <div>
                    <input
                      type="text"
